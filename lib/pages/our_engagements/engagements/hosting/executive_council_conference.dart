...
class ExecutiveCouncilConference extends StatefulWidget {
  const ExecutiveCouncilConference({super.key});

  @override
  State<ExecutiveCouncilConference> createState() => _ExecutiveCouncilConferenceState();
}

class _ExecutiveCouncilConferenceState extends State<ExecutiveCouncilConference> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Regular meetings to follow up on programs and activities",
                    textAlign: TextAlign.center,
                    style: TextStyle(
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    /// =======================
                    _sectionCard(
                      title: "Host Executive Council Conference",
                      primary: primary,
                      child: Column(
