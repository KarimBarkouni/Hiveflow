...
class GeneralConference extends StatefulWidget {
  const GeneralConference({super.key});

  @override
  State<GeneralConference> createState() => _GeneralConferenceState();
}

class _GeneralConferenceState extends State<GeneralConference> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "The supreme authority of ICESCO, held every 3 years",
                    textAlign: TextAlign.center,
                    style: TextStyle(
