...
class MinisterOfEducationReports extends StatefulWidget {
  const MinisterOfEducationReports({super.key});

  @override
  State<MinisterOfEducationReports> createState() => _MinisterOfEducationReportsState();
}

class _MinisterOfEducationReportsState extends State<MinisterOfEducationReports> {
