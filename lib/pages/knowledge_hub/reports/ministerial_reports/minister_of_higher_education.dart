...
import '../ministerial_conferences_reports.dart';

class MinisterOfHigherEducationReports extends StatefulWidget {
  const MinisterOfHigherEducationReports({super.key});

  @override
  State<MinisterOfHigherEducationReports> createState() => _MinisterOfHigherEducationReportsState();
}

class _MinisterOfHigherEducationReportsState extends State<MinisterOfHigherEducationReports> {
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Ministers Of Higher Education & Scientific Research",
                  ...
                  Text(
                    "CONFERENCES OF MINISTERS OF HIGHER EDUCATION & SCIENTIFIC RESEARCH",
                    textAlign: TextAlign.center,
                    style: TextStyle(
